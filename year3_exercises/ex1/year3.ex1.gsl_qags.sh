...
echo "set grid;  set title 'S(u) vs. C(u)';  set xlabel 'C(u)' ; set ylabel 'S(u)' ; set term gif; set output './year3.ex1.gsl.gif'; set multiplot ; plot 'qags_fresnel.dat' u 4:2 title 'estimated integrals'; unset multiplot" | /usr/bin/gnuplot
