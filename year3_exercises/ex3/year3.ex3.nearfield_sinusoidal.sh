...
GIF_NAME="./year3.ex3.nearfield_sinusoidal.gif"
...
#"plot 'nearfield_sinusoidal.dat' u 1:5 with lines lt 1 title 'grating'" \
#"; unset multiplot"   | /usr/bin/gnuplot
